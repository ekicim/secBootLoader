 ...
 * @{
 */
#define WDT_FEED_120_SECS	0x31ABA855 // 120 seconds.
#define WDT_FEED_30_SECS	0xC6AEA15 // 120 seconds.
#define WDT_FEED_VALUE_RTC	0x27BC828 // 30 secs RTC. 0x65B9A  = 2 secs

extern void WDT_IRQHandler(void);
uint32_t WDTInit(uint32_t feed);
extern void WDTFeed( void );
uint8_t WDT_SetTimeOutRTC(uint32_t timeout);
